...
var projects = [{
  ...
  items: [{
    ...
    description: "Developed this marketing site showcases the features of the SaaS product Trainn."
  }, {
    name: "Trainn - WebApp",
    ...
    description: "Developed a files and folder management app similar to Google Drive."
  }]
}, {
  ...
  items: [{
    ...
    description: "Developed and deployed over 35 screens for the Skooly mobile app."
  }, {
    name: "Skooly Marketing Site",
    technologies: "Html | Css | JavaScript | Eleventy",
    image: "skooly1.png",
    link: "https://getskooly.com/schools/en/",
    description: " Designed and developed all pages of the marketing site using Eleventy as the static site generator."
  }, {
    name: "Skooly Marketplace",
    technologies: "Angular | Sass",
    image: "skooly2.png",
    link: "https://getskooly.com/",
    description: "Developed authentication, quickChat, dashboard, and other UIs for school/academy management web app."
  }, {
    name: "Skooly Online Schools",
    technologies: "Vue | Sass",
    image: "online-schools.png",
    link: "https://getskooly.com/",
    description: "Developed UI for a web app where users can list their courses and schedules."
  }, {
    name: "Xerovi Admin Dashboard",
    technologies: "Vue | Sass",
    image: "xv-admin.png",
    link: "https://xv-admin-gracious-cray-c760c5.netlify.app/",
    description: "Designed/Developed a platform where admin can monitor the building during the pandemic time."
  }, {
  ...
  items: [{
    ...
    description: "Developed a website where users can see reviews and use cases of GPT software."
  }, {
    name: "StackAI",
    technologies: "Vue | Nuxt | Sass",
    image: "stackai.png",
    link: "https://stackai.co/",
    description: "Developed a website where users can see reviews of AI apps."
  }]
}, {
  ...
  items: [{
    ...
    description: "Platform where users can search and see Programming code snippets."
  }, {
    name: "Watch Trailers",
    technologies: "Nuxt | Sass",
    image: "watch-trailers.png",
    link: "https://watch-trailers.netlify.app/",
    description: "Developed a website where users can watch the latest trailers."
  }, {
    name: "Uisnip",
    technologies: "Nuxt | Sass",
    image: "uisnip.png",
    link: "https://uisnip.netlify.app/",
    description: "Developed a website where I can post UI code snippets with a preview."
  }, {
    name: "Templatezip",
    ...
    description: "Platform to sell Website/Ionic templates. Integrated with 'Stripe' for payments."
  }, {
    name: "Webdevfix",
    technologies: "Nuxt | Sass",
    image: "webdevfix.png",
    ...
    description: "Platform where users can view and add Food Recipes. Experimental/Unfinished project."
  }, {
    name: "Website Builder",
    technologies: "Vue 3 | Sass",
    image: "web-builder.png",
    link: "https://angry-albattani-0b857d.netlify.app",
    description: "Platform where users can create webpages using the drag and drop method. Experimental project."
  }, {
    ...
    description: "A drawing board where the user can use the mouse to draw on the screen. Experimental project."
  }, {
    name: "Fallinfo - A Blogging Site",
    technologies: "Html | Css | JavaScript | jQuery",
    image: "fallinfo.png",
    link: "https://naughty-montalcini-80b80f.netlify.app/",
    description: "A blogging website I've developed to post articles about development. Experimental project."
  }, {
    ...
    description: "Website where users can generate large sets of HTML tables with GUI. Experimental project."
  }, {
    name: "YouVsBot",
    technologies: "Vue | Sass",
    image: "youvsbot.png",
    link: "https://zen-pike-e7a567.netlify.app/#/",
    description: "Simple gaming web app with 4 different games. Learning/Experimental project."
  }]
}];
    ...
    React.createElement(
      ...
      projects.map(function (project) {
        return React.createElement(
          ...
          React.createElement(
            "div",
            { className: "grid grid-cols-1 min-[440px]:grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6" },
...
function Contact(props) {
  ...
  function onEmail(e) {
    setEmail(function (prev) {
      if (!e.target.value || !e.target.value.match(/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|.(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/)) {
        setEmailError(true);
      } else {
        setEmailError(false);
      }
  ...
  return React.createElement(
    "div",
    { id: "contact", className: "max-w-7xl mx-auto px-6 md:px-12 py-12 md:flex" },
    React.createElement(
      "div",
      { className: "flex-1" },
      React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "span",
          {
            className: "text-sm text-red-700 " + (emailError ? "opacity-1" : "opacity-0")
          },
          "Enter a valid Email"
        )
      ),
      React.createElement(
        ...
        React.createElement(
          "span",
          {
            className: "text-sm text-red-700 " + (messageError ? "opacity-1" : "opacity-0")
          },
          "Enter the message"
        )
      ),
